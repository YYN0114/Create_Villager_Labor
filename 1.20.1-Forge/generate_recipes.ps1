# Generate material-variant recipes for CreateLabor Villager Forge 1.20.1
$recipeDir = "e:\git\Minecraft\MC MOD\CL CreateLabor Villager\1.20.1-Forge\src\main\resources\data\create_labor\recipes"
