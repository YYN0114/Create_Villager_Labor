...
public final class FarmerDelightHelper {
    ...
    private static final ResourceLocation FD_COOKING_ID = new ResourceLocation("farmersdelight:cooking");
    ...
    public static Optional<FdCookingMatch> tryMatchCookingRecipe(Level level, BasinBlockEntity basinBE, IItemHandler inputInv) {
        ...
        for (Recipe<?> recipe : allRecipes) {
            ...
            return Optional.of(new FdCookingMatch(recipe, matchedSlots, maxBatch));
        }
    ...
    public static class FdCookingMatch {
        ...
        public FdCookingMatch(Recipe<?> recipe, List<Integer> matchedSlots, int batchSize) {
            this.recipe = recipe;
