 ...
 * 支持原版村民、玩家、东方女仆、千年村庄村民，
 * 以及通过 create_labor:workers 标签兼容凡家物语(MCA)、模拟殖民地(Minecolonies)、守卫村民(GuardVillagers)等。
 */
public final class WorkerUtil {
    ...
    public static final TagKey<net.minecraft.world.entity.EntityType<?>> WORKER_TAG =
        TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath("create_labor", "workers"));
