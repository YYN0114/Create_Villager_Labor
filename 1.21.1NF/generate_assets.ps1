# Generate material-variant assets for CreateLabor Villager NF 1.21.1
$baseDir = "e:\git\Minecraft\MC MOD\CL CreateLabor Villager\1.21.1NF\src\main\resources\assets\create_labor"
